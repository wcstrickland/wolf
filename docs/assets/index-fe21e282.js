(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))l(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const f of s.addedNodes)f.tagName==="LINK"&&f.rel==="modulepreload"&&l(f)}).observe(document,{childList:!0,subtree:!0});function n(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function l(o){if(o.ep)return;o.ep=!0;const s=n(o);fetch(o.href,s)}})();function P(){}function kl(t){return t()}function ll(){return Object.create(null)}function ue(t){t.forEach(kl)}function gl(t){return typeof t=="function"}function K(t,e){return t!=t?e==e:t!==e||t&&typeof t=="object"||typeof t=="function"}function Tl(t){return Object.keys(t).length===0}function Sl(t,...e){if(t==null)return P;const n=t.subscribe(...e);return n.unsubscribe?()=>n.unsubscribe():n}function Ee(t,e,n){t.$$.on_destroy.push(Sl(e,n))}function u(t,e){t.appendChild(e)}function c(t,e,n){t.insertBefore(e,n||null)}function a(t){t.parentNode&&t.parentNode.removeChild(t)}function Zi(t,e){for(let n=0;n<t.length;n+=1)t[n]&&t[n].d(e)}function r(t){return document.createElement(t)}function F(t){return document.createTextNode(t)}function d(){return F(" ")}function Cl(){return F("")}function x(t,e,n,l){return t.addEventListener(e,n,l),()=>t.removeEventListener(e,n,l)}function A(t,e,n){n==null?t.removeAttribute(e):t.getAttribute(e)!==n&&t.setAttribute(e,n)}function jl(t){return Array.from(t.childNodes)}function se(t,e){e=""+e,t.data!==e&&(t.data=e)}function oe(t,e){t.value=e??""}function b(t,e,n,l){n==null?t.style.removeProperty(e):t.style.setProperty(e,n,l?"important":"")}let Xi;function Ne(t){Xi=t}const Pe=[],nl=[];let qe=[];const ol=[],Ml=Promise.resolve();let Qi=!1;function Al(){Qi||(Qi=!0,Ml.then(_l))}function Yi(t){qe.push(t)}const Ui=new Set;let Ae=0;function _l(){if(Ae!==0)return;const t=Xi;do{try{for(;Ae<Pe.length;){const e=Pe[Ae];Ae++,Ne(e),Ll(e.$$)}}catch(e){throw Pe.length=0,Ae=0,e}for(Ne(null),Pe.length=0,Ae=0;nl.length;)nl.pop()();for(let e=0;e<qe.length;e+=1){const n=qe[e];Ui.has(n)||(Ui.add(n),n())}qe.length=0}while(Pe.length);for(;ol.length;)ol.pop()();Qi=!1,Ui.clear(),Ne(t)}function Ll(t){if(t.fragment!==null){t.update(),ue(t.before_update);const e=t.dirty;t.dirty=[-1],t.fragment&&t.fragment.p(t.ctx,e),t.after_update.forEach(Yi)}}function Hl(t){const e=[],n=[];qe.forEach(l=>t.indexOf(l)===-1?e.push(l):n.push(l)),n.forEach(l=>l()),qe=e}const Mt=new Set;let ve;function Re(){ve={r:0,c:[],p:ve}}function De(){ve.r||ue(ve.c),ve=ve.p}function H(t,e){t&&t.i&&(Mt.delete(t),t.i(e))}function D(t,e,n,l){if(t&&t.o){if(Mt.has(t))return;Mt.add(t),ve.c.push(()=>{Mt.delete(t),l&&(n&&t.d(1),l())}),t.o(e)}else l&&l()}function N(t){t&&t.c()}function W(t,e,n,l){const{fragment:o,after_update:s}=t.$$;o&&o.m(e,n),l||Yi(()=>{const f=t.$$.on_mount.map(kl).filter(gl);t.$$.on_destroy?t.$$.on_destroy.push(...f):ue(f),t.$$.on_mount=[]}),s.forEach(Yi)}function V(t,e){const n=t.$$;n.fragment!==null&&(Hl(n.after_update),ue(n.on_destroy),n.fragment&&n.fragment.d(e),n.on_destroy=n.fragment=null,n.ctx=[])}function Pl(t,e){t.$$.dirty[0]===-1&&(Pe.push(t),Al(),t.$$.dirty.fill(0)),t.$$.dirty[e/31|0]|=1<<e%31}function G(t,e,n,l,o,s,f,m=[-1]){const y=Xi;Ne(t);const v=t.$$={fragment:null,ctx:[],props:s,update:P,not_equal:o,bound:ll(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(e.context||(y?y.$$.context:[])),callbacks:ll(),dirty:m,skip_bound:!1,root:e.target||y.$$.root};f&&f(v.root);let k=!1;if(v.ctx=n?n(t,e.props||{},(_,g,...j)=>{const w=j.length?j[0]:g;return v.ctx&&o(v.ctx[_],v.ctx[_]=w)&&(!v.skip_bound&&v.bound[_]&&v.bound[_](w),k&&Pl(t,_)),g}):[],v.update(),k=!0,ue(v.before_update),v.fragment=l?l(v.ctx):!1,e.target){if(e.hydrate){const _=jl(e.target);v.fragment&&v.fragment.l(_),_.forEach(a)}else v.fragment&&v.fragment.c();e.intro&&H(t.$$.fragment),W(t,e.target,e.anchor,e.customElement),_l()}Ne(y)}class U{$destroy(){V(this,1),this.$destroy=P}$on(e,n){if(!gl(n))return P;const l=this.$$.callbacks[e]||(this.$$.callbacks[e]=[]);return l.push(n),()=>{const o=l.indexOf(n);o!==-1&&l.splice(o,1)}}$set(e){this.$$set&&!Tl(e)&&(this.$$.skip_bound=!0,this.$$set(e),this.$$.skip_bound=!1)}}const Le=[];function xl(t,e=P){let n;const l=new Set;function o(m){if(K(t,m)&&(t=m,n)){const y=!Le.length;for(const v of l)v[1](),Le.push(v,t);if(y){for(let v=0;v<Le.length;v+=2)Le[v][0](Le[v+1]);Le.length=0}}}function s(m){o(m(t))}function f(m,y=P){const v=[m,y];return l.add(v),l.size===1&&(n=e(o)||P),m(t),()=>{l.delete(v),l.size===0&&n&&(n(),n=null)}}return{set:o,update:s,subscribe:f}}const wl=xl("home"),Ve=t=>{wl.update(e=>t),window.scroll(0,0)},re=xl(JSON.parse(localStorage.getItem("form"))||{});function Ie(t,e){re.update(n=>(n[t]=e,n))}function ql(t){let e,n,l,o,s,f,m,y,v,k,_,g,j,w,T,L,M,E,q,C,B;return{c(){e=r("div"),n=r("div"),l=F(t[1]),o=d(),s=r("div"),f=r("input"),y=d(),v=r("input"),_=d(),g=r("input"),w=d(),T=r("input"),M=d(),E=r("input"),b(n,"display","flex"),b(n,"justify-content","flex-start"),A(f,"type","checkbox"),f.checked=m=t[0]>=1,A(v,"type","checkbox"),v.checked=k=t[0]>=2,A(g,"type","checkbox"),g.checked=j=t[0]>=3,A(T,"type","checkbox"),T.checked=L=t[0]>=4,A(E,"type","checkbox"),E.checked=q=t[0]>=5,b(s,"display","flex"),b(s,"justify-content","flex-end"),b(e,"display","flex"),b(e,"justify-content","space-between")},m(S,p){c(S,e,p),u(e,n),u(n,l),u(e,o),u(e,s),u(s,f),u(s,y),u(s,v),u(s,_),u(s,g),u(s,w),u(s,T),u(s,M),u(s,E),C||(B=[x(f,"click",t[3]),x(v,"click",t[4]),x(g,"click",t[5]),x(T,"click",t[6]),x(E,"click",t[7])],C=!0)},p(S,[p]){p&2&&se(l,S[1]),p&1&&m!==(m=S[0]>=1)&&(f.checked=m),p&1&&k!==(k=S[0]>=2)&&(v.checked=k),p&1&&j!==(j=S[0]>=3)&&(g.checked=j),p&1&&L!==(L=S[0]>=4)&&(T.checked=L),p&1&&q!==(q=S[0]>=5)&&(E.checked=q)},i:P,o:P,d(S){S&&a(e),C=!1,ue(B)}}}function Rl(t,e,n){let l;Ee(t,re,g=>n(8,l=g));let{title:o}=e,{val:s=l[o]||0}=e;function f(g){s===g?(Ie(o,g-1),n(0,s=l[o])):(Ie(o,g),n(0,s=l[o]))}const m=()=>f(1),y=()=>f(2),v=()=>f(3),k=()=>f(4),_=()=>f(5);return t.$$set=g=>{"title"in g&&n(1,o=g.title),"val"in g&&n(0,s=g.val)},[s,o,f,m,y,v,k,_]}class Dl extends U{constructor(e){super(),G(this,e,Rl,ql,K,{title:1,val:0})}}function sl(t,e,n){const l=t.slice();return l[2]=e[n],l}function El(t){return{c:P,m:P,p:P,d:P}}function Il(t){let e,n;return{c(){e=r("b"),n=F(t[0])},m(l,o){c(l,e,o),u(e,n)},p(l,o){o&1&&se(n,l[0])},d(l){l&&a(e)}}}function rl(t){let e,n;return e=new Dl({props:{title:t[2]}}),{c(){N(e.$$.fragment)},m(l,o){W(e,l,o),n=!0},p(l,o){const s={};o&2&&(s.title=l[2]),e.$set(s)},i(l){n||(H(e.$$.fragment,l),n=!0)},o(l){D(e.$$.fragment,l),n=!1},d(l){V(e,l)}}}function Ol(t){let e,n,l;function o(k,_){return k[0]!=""?Il:El}let s=o(t),f=s(t),m=t[1],y=[];for(let k=0;k<m.length;k+=1)y[k]=rl(sl(t,m,k));const v=k=>D(y[k],1,1,()=>{y[k]=null});return{c(){e=r("article"),f.c(),n=d();for(let k=0;k<y.length;k+=1)y[k].c();b(e,"margin-left","1em"),b(e,"margin-right","1em")},m(k,_){c(k,e,_),f.m(e,null),u(e,n);for(let g=0;g<y.length;g+=1)y[g]&&y[g].m(e,null);l=!0},p(k,[_]){if(s===(s=o(k))&&f?f.p(k,_):(f.d(1),f=s(k),f&&(f.c(),f.m(e,n))),_&2){m=k[1];let g;for(g=0;g<m.length;g+=1){const j=sl(k,m,g);y[g]?(y[g].p(j,_),H(y[g],1)):(y[g]=rl(j),y[g].c(),H(y[g],1),y[g].m(e,null))}for(Re(),g=m.length;g<y.length;g+=1)v(g);De()}},i(k){if(!l){for(let _=0;_<m.length;_+=1)H(y[_]);l=!0}},o(k){y=y.filter(Boolean);for(let _=0;_<y.length;_+=1)D(y[_]);l=!1},d(k){k&&a(e),f.d(),Zi(y,k)}}}function Bl(t,e,n){let{title:l}=e,{blocks:o=[]}=e;return t.$$set=s=>{"title"in s&&n(0,l=s.title),"blocks"in s&&n(1,o=s.blocks)},[l,o]}class He extends U{constructor(e){super(),G(this,e,Bl,Ol,K,{title:0,blocks:1})}}function al(t,e,n){const l=t.slice();return l[1]=e[n],l}function Fl(t){let e,n=t[1]+"",l;return{c(){e=r("span"),l=F(n),A(e,"class","partial svelte-3bhriv")},m(o,s){c(o,e,s),u(e,l)},p(o,s){s&1&&n!==(n=o[1]+"")&&se(l,n)},d(o){o&&a(e)}}}function zl(t){let e,n=t[1]+"",l;return{c(){e=r("span"),l=F(n),A(e,"class","failure svelte-3bhriv")},m(o,s){c(o,e,s),u(e,l)},p(o,s){s&1&&n!==(n=o[1]+"")&&se(l,n)},d(o){o&&a(e)}}}function Wl(t){let e,n=t[1]+"",l;return{c(){e=r("span"),l=F(n),A(e,"class","success svelte-3bhriv")},m(o,s){c(o,e,s),u(e,l)},p(o,s){s&1&&n!==(n=o[1]+"")&&se(l,n)},d(o){o&&a(e)}}}function cl(t){let e;function n(s,f){return s[1]>4?Wl:s[1]<4?zl:Fl}let l=n(t),o=l(t);return{c(){o.c(),e=Cl()},m(s,f){o.m(s,f),c(s,e,f)},p(s,f){l===(l=n(s))&&o?o.p(s,f):(o.d(1),o=l(s),o&&(o.c(),o.m(e.parentNode,e)))},d(s){o.d(s),s&&a(e)}}}function Vl(t){let e,n=t[0],l=[];for(let o=0;o<n.length;o+=1)l[o]=cl(al(t,n,o));return{c(){e=r("div");for(let o=0;o<l.length;o+=1)l[o].c();A(e,"id","result-box"),A(e,"class","svelte-3bhriv")},m(o,s){c(o,e,s);for(let f=0;f<l.length;f+=1)l[f]&&l[f].m(e,null)},p(o,[s]){if(s&1){n=o[0];let f;for(f=0;f<n.length;f+=1){const m=al(o,n,f);l[f]?l[f].p(m,s):(l[f]=cl(m),l[f].c(),l[f].m(e,null))}for(;f<l.length;f+=1)l[f].d(1);l.length=n.length}},i:P,o:P,d(o){o&&a(e),Zi(l,o)}}}function Nl(t,e,n){let{result:l}=e;return t.$$set=o=>{"result"in o&&n(0,l=o.result)},[l]}class Jl extends U{constructor(e){super(),G(this,e,Nl,Vl,K,{result:0})}}function Kl(t){let e,n,l,o,s,f,m,y,v,k,_,g,j,w,T,L,M,E,q,C,B,S;return q=new Jl({props:{result:t[0]}}),{c(){e=r("button"),e.textContent="1",n=d(),l=r("button"),l.textContent="2",o=d(),s=r("button"),s.textContent="3",f=d(),m=r("button"),m.textContent="4",y=d(),v=r("button"),v.textContent="5",k=d(),_=r("button"),_.textContent="6",g=d(),j=r("button"),j.textContent="7",w=d(),T=r("button"),T.textContent="8",L=d(),M=r("button"),M.textContent="9",E=d(),N(q.$$.fragment),b(e,"margin-top","1em"),b(e,"margin-bottom","1em"),b(l,"margin-top","1em"),b(s,"margin-top","1em"),b(m,"margin-top","1em"),b(v,"margin-top","1em"),b(_,"margin-top","1em"),b(j,"margin-top","1em"),b(T,"margin-top","1em"),b(M,"margin-top","1em")},m(p,$){c(p,e,$),c(p,n,$),c(p,l,$),c(p,o,$),c(p,s,$),c(p,f,$),c(p,m,$),c(p,y,$),c(p,v,$),c(p,k,$),c(p,_,$),c(p,g,$),c(p,j,$),c(p,w,$),c(p,T,$),c(p,L,$),c(p,M,$),c(p,E,$),W(q,p,$),C=!0,B||(S=[x(e,"click",t[2]),x(l,"click",t[3]),x(s,"click",t[4]),x(m,"click",t[5]),x(v,"click",t[6]),x(_,"click",t[7]),x(j,"click",t[8]),x(T,"click",t[9]),x(M,"click",t[10])],B=!0)},p(p,[$]){const I={};$&1&&(I.result=p[0]),q.$set(I)},i(p){C||(H(q.$$.fragment,p),C=!0)},o(p){D(q.$$.fragment,p),C=!1},d(p){p&&a(e),p&&a(n),p&&a(l),p&&a(o),p&&a(s),p&&a(f),p&&a(m),p&&a(y),p&&a(v),p&&a(k),p&&a(_),p&&a(g),p&&a(j),p&&a(w),p&&a(T),p&&a(L),p&&a(M),p&&a(E),V(q,p),B=!1,ue(S)}}}function Gl(t,e){return Math.floor(Math.random()*(e-t+1)+t)}function Ul(t,e,n){let l=[],o="";function s(T){l=[];for(let L=1;L<=T;L++){let M=Gl(1,6);l.push(M)}n(0,o=l)}return[o,s,()=>s(1),()=>s(2),()=>s(3),()=>s(4),()=>s(5),()=>s(6),()=>s(7),()=>s(8),()=>s(9)]}class Ql extends U{constructor(e){super(),G(this,e,Ul,Kl,K,{})}}function ul(t){let e,n;return e=new Ql({}),{c(){N(e.$$.fragment)},m(l,o){W(e,l,o),n=!0},i(l){n||(H(e.$$.fragment,l),n=!0)},o(l){D(e.$$.fragment,l),n=!1},d(l){V(e,l)}}}function Yl(t){let e,n,l,o,s,f,m=t[0]&&ul();return{c(){e=r("div"),n=r("button"),n.textContent="Roll",l=d(),m&&m.c(),A(n,"id","Roll-btn"),A(e,"class","Roll-btn-container svelte-yfvcl4")},m(y,v){c(y,e,v),u(e,n),u(e,l),m&&m.m(e,null),o=!0,s||(f=x(n,"click",t[1]),s=!0)},p(y,[v]){y[0]?m?v&1&&H(m,1):(m=ul(),m.c(),H(m,1),m.m(e,null)):m&&(Re(),D(m,1,1,()=>{m=null}),De())},i(y){o||(H(m),o=!0)},o(y){D(m),o=!1},d(y){y&&a(e),m&&m.d(),s=!1,f()}}}function Zl(t,e,n){let l=!1;return[l,()=>n(0,l=!l)]}class Xl extends U{constructor(e){super(),G(this,e,Zl,Yl,K,{})}}function en(t){let e,n,l;return{c(){e=r("input"),A(e,"type","text"),b(e,"margin-left",".5em"),b(e,"width","140px")},m(o,s){c(o,e,s),oe(e,t[2].viceWord),n||(l=x(e,"input",t[5]),n=!0)},p(o,s){s&4&&e.value!==o[2].viceWord&&oe(e,o[2].viceWord)},d(o){o&&a(e),n=!1,l()}}}function tn(t){let e,n,l;return{c(){e=r("input"),A(e,"type","text"),b(e,"margin-left",".5em"),b(e,"width","140px")},m(o,s){c(o,e,s),oe(e,t[2].virtueWord),n||(l=x(e,"input",t[4]),n=!0)},p(o,s){s&4&&e.value!==o[2].virtueWord&&oe(e,o[2].virtueWord)},d(o){o&&a(e),n=!1,l()}}}function ln(t){let e,n,l,o,s,f,m,y,v,k,_,g,j,w,T,L,M,E,q,C,B,S;function p(O,z){return O[1]==="Virtue"?tn:en}let $=p(t),I=$(t);return{c(){e=r("div"),n=r("div"),l=F(t[1]),o=F(`: \r
    `),I.c(),s=d(),f=r("div"),m=r("input"),v=d(),k=r("input"),g=d(),j=r("input"),T=d(),L=r("input"),E=d(),q=r("input"),b(n,"display","flex"),b(n,"justify-content","flex-start"),A(m,"type","checkbox"),m.checked=y=t[0]>=1,A(k,"type","checkbox"),k.checked=_=t[0]>=2,A(j,"type","checkbox"),j.checked=w=t[0]>=3,A(L,"type","checkbox"),L.checked=M=t[0]>=4,A(q,"type","checkbox"),q.checked=C=t[0]>=5,b(f,"display","flex"),b(f,"justify-content","flex-end"),b(e,"display","flex")},m(O,z){c(O,e,z),u(e,n),u(n,l),u(n,o),I.m(n,null),u(e,s),u(e,f),u(f,m),u(f,v),u(f,k),u(f,g),u(f,j),u(f,T),u(f,L),u(f,E),u(f,q),B||(S=[x(m,"click",t[6]),x(k,"click",t[7]),x(j,"click",t[8]),x(L,"click",t[9]),x(q,"click",t[10])],B=!0)},p(O,[z]){z&2&&se(l,O[1]),$===($=p(O))&&I?I.p(O,z):(I.d(1),I=$(O),I&&(I.c(),I.m(n,null))),z&1&&y!==(y=O[0]>=1)&&(m.checked=y),z&1&&_!==(_=O[0]>=2)&&(k.checked=_),z&1&&w!==(w=O[0]>=3)&&(j.checked=w),z&1&&M!==(M=O[0]>=4)&&(L.checked=M),z&1&&C!==(C=O[0]>=5)&&(q.checked=C)},i:P,o:P,d(O){O&&a(e),I.d(),B=!1,ue(S)}}}function nn(t,e,n){let l;Ee(t,re,w=>n(2,l=w));let{title:o}=e,{val:s=l[o]||0}=e;function f(w){s===w?(Ie(o,w-1),n(0,s=l[o])):(Ie(o,w),n(0,s=l[o]))}function m(){l.virtueWord=this.value,re.set(l)}function y(){l.viceWord=this.value,re.set(l)}const v=()=>f(1),k=()=>f(2),_=()=>f(3),g=()=>f(4),j=()=>f(5);return t.$$set=w=>{"title"in w&&n(1,o=w.title),"val"in w&&n(0,s=w.val)},[s,o,l,f,m,y,v,k,_,g,j]}class fl extends U{constructor(e){super(),G(this,e,nn,ln,K,{title:1,val:0})}}function on(t){let e,n,l,o,s,f,m,y,v,k,_,g,j,w,T,L,M,E,q,C,B,S,p,$,I,O,z;return{c(){e=r("div"),n=r("div"),l=r("div"),l.textContent="Hurt",o=d(),s=r("input"),f=d(),m=r("div"),y=r("div"),y.textContent="Injured",v=d(),k=r("input"),_=d(),g=r("div"),j=r("div"),j.textContent="Wounded",w=d(),T=r("input"),L=d(),M=r("div"),E=r("div"),E.textContent="Maimed",q=d(),C=r("input"),B=d(),S=r("div"),p=r("div"),p.textContent="Incapacitated",$=d(),I=r("input"),A(s,"type","checkbox"),s.checked=t[0],b(n,"display","flex"),b(n,"flex-direction","column"),A(k,"type","checkbox"),k.checked=t[1],b(m,"display","flex"),b(m,"flex-direction","column"),A(T,"type","checkbox"),T.checked=t[2],b(g,"display","flex"),b(g,"flex-direction","column"),A(C,"type","checkbox"),C.checked=t[3],b(M,"display","flex"),b(M,"flex-direction","column"),A(I,"type","checkbox"),I.checked=t[4],b(S,"display","flex"),b(S,"flex-direction","column"),b(e,"display","flex"),b(e,"justify-content","space-between"),b(e,"margin-top",".5em"),b(e,"margin-bottom",".5em")},m(ae,ce){c(ae,e,ce),u(e,n),u(n,l),u(n,o),u(n,s),u(e,f),u(e,m),u(m,y),u(m,v),u(m,k),u(e,_),u(e,g),u(g,j),u(g,w),u(g,T),u(e,L),u(e,M),u(M,E),u(M,q),u(M,C),u(e,B),u(e,S),u(S,p),u(S,$),u(S,I),O||(z=[x(s,"click",t[6]),x(k,"click",t[7]),x(T,"click",t[8]),x(C,"click",t[9]),x(I,"click",t[10])],O=!0)},p:P,i:P,o:P,d(ae){ae&&a(e),O=!1,ue(z)}}}function sn(t,e,n){let l;Ee(t,re,T=>n(11,l=T));let o=l.hurt||!1,s=l.injured||!1,f=l.wounded||!1,m=l.maimed||!1,y=l.incapacitated||!1;function v(T){let L=l[T];Ie(T,!L)}return[o,s,f,m,y,v,()=>v("hurt"),()=>v("injured"),()=>v("wounded"),()=>v("maimed"),()=>v("incapacitated")]}class rn extends U{constructor(e){super(),G(this,e,sn,on,K,{})}}function an(t){let e,n,l,o,s,f,m,y,v,k,_,g,j,w,T,L,M,E,q,C,B,S,p,$,I,O,z;return{c(){e=r("div"),n=r("div"),l=r("div"),l.textContent="Nervous",o=d(),s=r("input"),f=d(),m=r("div"),y=r("div"),y.textContent="Anxious",v=d(),k=r("input"),_=d(),g=r("div"),j=r("div"),j.textContent="Panicked",w=d(),T=r("input"),L=d(),M=r("div"),E=r("div"),E.textContent="Crazed",q=d(),C=r("input"),B=d(),S=r("div"),p=r("div"),p.textContent="Insane",$=d(),I=r("input"),A(s,"type","checkbox"),s.checked=t[0],b(n,"display","flex"),b(n,"flex-direction","column"),A(k,"type","checkbox"),k.checked=t[1],b(m,"display","flex"),b(m,"flex-direction","column"),A(T,"type","checkbox"),T.checked=t[2],b(g,"display","flex"),b(g,"flex-direction","column"),A(C,"type","checkbox"),C.checked=t[3],b(M,"display","flex"),b(M,"flex-direction","column"),A(I,"type","checkbox"),I.checked=t[4],b(S,"display","flex"),b(S,"flex-direction","column"),b(e,"display","flex"),b(e,"justify-content","space-between"),b(e,"margin-top",".5em")},m(ae,ce){c(ae,e,ce),u(e,n),u(n,l),u(n,o),u(n,s),u(e,f),u(e,m),u(m,y),u(m,v),u(m,k),u(e,_),u(e,g),u(g,j),u(g,w),u(g,T),u(e,L),u(e,M),u(M,E),u(M,q),u(M,C),u(e,B),u(e,S),u(S,p),u(S,$),u(S,I),O||(z=[x(s,"click",t[6]),x(k,"click",t[7]),x(T,"click",t[8]),x(C,"click",t[9]),x(I,"click",t[10])],O=!0)},p:P,i:P,o:P,d(ae){ae&&a(e),O=!1,ue(z)}}}function cn(t,e,n){let l;Ee(t,re,T=>n(11,l=T));let o=l.nervous||!1,s=l.anxious||!1,f=l.panicked||!1,m=l.crazed||!1,y=l.insane||!1;function v(T){let L=l[T];Ie(T,!L)}return[o,s,f,m,y,v,()=>v("nervous"),()=>v("anxious"),()=>v("panicked"),()=>v("crazed"),()=>v("insane")]}class un extends U{constructor(e){super(),G(this,e,cn,an,K,{})}}function fn(t){let e;return{c(){e=r("div"),e.innerHTML=`<b>Jack of All Trades</b> 
  ...
  <div style="display:flex;"><div style="display:flex;justify-content:flex-start;"><input type="checkbox" checked="${!0}" disabled=""/> 
      ...
      <input type="checkbox" disabled=""/> 
      <input type="checkbox" disabled=""/> 
      <div style="display:flex;justify-content:flex-end;margin-left:1em;">Ten Skills</div></div></div>`,b(e,"margin-bottom","1em")},m(n,l){c(n,e,l)},p:P,i:P,o:P,d(n){n&&a(e)}}}class dn extends U{constructor(e){super(),G(this,e,null,fn,K,{})}}function pn(t){let e;return{c(){e=r("div"),e.innerHTML=`<b>Specialist</b> 
  ...
  <div style="display:flex;"><div style="display:flex;justify-content:flex-start;"><input type="checkbox" checked="${!0}" disabled=""/> 
      ...
      <input type="checkbox" disabled=""/> 
      <input type="checkbox" disabled=""/> 
      <div style="display:flex;justify-content:flex-end;margin-left:1em;">Three Skills</div></div></div>`,b(e,"margin-bottom","1em")},m(n,l){c(n,e,l)},p:P,i:P,o:P,d(n){n&&a(e)}}}class mn extends U{constructor(e){super(),G(this,e,null,pn,K,{})}}function hn(t){let e;return{c(){e=r("div"),e.innerHTML=`<b>Balanced</b> 
  ...
  <li>Melee - the familiarity with weapons such as knives, swords, or clubs</li>`,E=d(),q=r("li"),q.innerHTML=`<h3><b>Social</b> Skills often represent practiced and honed natural knack.</h3> 
  ...
  <ul style="text-align:start"><li>Academics - knowledge in Arts and Humanities</li> 
    ...
    <li>Craft - constructing, crafting, and repairing objects</li></ul>`,b(f,"display","flex"),b(f,"justify-content","space-evenly"),b(M,"text-align","start")},m(p,$){c(p,e,$),c(p,n,$),c(p,l,$),u(l,o),u(l,s),u(l,f),W(m,f,null),u(f,y),W(v,f,null),u(f,k),W(_,f,null),u(l,g),u(l,j),c(p,w,$),c(p,T,$),c(p,L,$),c(p,M,$),c(p,E,$),c(p,q,$),c(p,C,$),c(p,B,$),S=!0},p:P,i(p){S||(H(m.$$.fragment,p),H(v.$$.fragment,p),H(_.$$.fragment,p),S=!0)},o(p){D(m.$$.fragment,p),D(v.$$.fragment,p),D(_.$$.fragment,p),S=!1},d(p){p&&a(e),p&&a(n),p&&a(l),V(m),V(v),V(_),p&&a(w),p&&a(T),p&&a(L),p&&a(M),p&&a(E),p&&a(q),p&&a(C),p&&a(B)}}}class vn extends U{constructor(e){super(),G(this,e,null,yn,K,{})}}function kn(t){let e;return{c(){e=r("div"),e.innerHTML=`<div class="flex svelte-c1ty8y"><div class="flex start svelte-c1ty8y"><input type="checkbox" checked="${!0}" disabled=""/> 
      <input type="checkbox" checked="${!0}" disabled=""/> 
      <input type="checkbox" checked="${!0}" disabled=""/> 
      <input type="checkbox" checked="${!0}" disabled=""/> 
      <input type="checkbox" disabled=""/> 
  ...
  <div class="flex svelte-c1ty8y"><div class="flex start svelte-c1ty8y"><input type="checkbox" checked="${!0}" disabled=""/> 
    ...
    <div class="flex end svelte-c1ty8y" style="margin-left:1em;">One Attribute</div></div>`},m(n,l){c(n,e,l)},p:P,i:P,o:P,d(n){n&&a(e)}}}class gn extends U{constructor(e){super(),G(this,e,null,kn,K,{})}}function _n(t){let e,n,l,o,s,f,m,y,v;return o=new gn({}),{c(){e=r("h2"),e.textContent="Attributes",n=F(`\r
