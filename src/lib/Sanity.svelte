...
<div style="display: flex; justify-content:space-between;margin-top:.5em;">
    <div style="display: flex; flex-direction:column;">
        <div>Nervous</div>
        <input type="checkbox" checked={nervous} on:click={()=> toggle("nervous")}/>
    </div>
    <div style="display: flex; flex-direction:column;">
        <div>Anxious</div>
        <input type="checkbox" checked={anxious} on:click={()=> toggle("anxious")}/>
    </div>
    <div style="display: flex; flex-direction:column;">
        <div>Panicked</div>
        <input type="checkbox" checked={panicked} on:click={()=> toggle("panicked")}/>
    </div>
    <div style="display: flex; flex-direction:column;">
        <div>Crazed</div>
